...
class _RegisterLabourScreenState extends State<RegisterLabourScreen> {
  ...
  Future<void> _submit() async {
    ...
    if (_selectedSkillIds.isEmpty) { ToastUtils.showError('Select at least one skill'); return; }
                      ...
                      child: Row(
                        children: [
                          ...
                          Icon(
                            ...
                            color: _skillsLoading ? const Color(0xFF9CA3AF) : const Color(0xFF6B7280),
                          ),
                        ],
                      ),
                    ),
                    ...
                    Wrap(
                      ...
                      children: _selectedSkillIds.map((skillId) {
                        ...
                        return Chip(
                          ...
                          onDeleted: () => setState(() => _selectedSkillIds.remove(skillId)),

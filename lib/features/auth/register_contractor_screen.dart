      ...
      child: Container(
        ...
        child: Row(children: [
          Icon(
            ...
            size: 20,
            color: done ? const Color(0xFF059669) : uploading ? const Color(0xFFF59E0B) : const Color(0xFF9CA3AF),
          ),
          const SizedBox(width: 10),
          Expanded(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text(label, style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600,
                  color: done ? const Color(0xFF059669) : const Color(0xFF374151))),
              const SizedBox(height: 2),
              Text(
                uploading ? 'Uploading...' : done ? 'Uploaded ✓' : hint,
                style: TextStyle(fontSize: 11, color: done ? const Color(0xFF059669) : const Color(0xFF9CA3AF)),
              ),
            ]),
          ),
          if (uploading)
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
                ...
                child: GestureDetector(
                  ...
                  child: Stack(children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        shape: BoxShape.circle, color: const Color(0xFFECFDF5),
                        border: Border.all(
                      ...
                      child: ClipOval(
                        child: _logoBytes != null
                            ...
                            : const Icon(Icons.business_center_rounded, size: 42, color: _primary),
                      ),
                    ),
                    if (_logoUploading)
              ...
              // ── Personal Info ───────────────────────────────
              _sectionCard(
                title: 'Personal Information', icon: Icons.person_outline_rounded, color: const Color(0xFF2563EB),
                children: [
                  TextFormField(
                    controller: _nameController, textCapitalization: TextCapitalization.words,
                    decoration: _dec('Full Name *', hint: 'Owner / Manager name', prefix: const Icon(Icons.person_outline_rounded, size: 20)),
                    validator: (v) => (v == null || v.trim().isEmpty) ? 'Full name is required' : null,
                  ),
                  const SizedBox(height: 14),
                  TextFormField(
                    controller: _emailController,
                    decoration: _dec('Email Address *', hint: 'name@company.com', prefix: const Icon(Icons.email_outlined, size: 20)),
              ...
              // ── Business Info ───────────────────────────────
              _sectionCard(
                title: 'Business Information', icon: Icons.business_center_rounded, color: _primary,
                children: [
                  TextFormField(
                    controller: _businessNameController, textCapitalization: TextCapitalization.words,
                    decoration: _dec('Business Name *', hint: 'Your company / firm name', prefix: const Icon(Icons.storefront_outlined, size: 20)),
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    items: _teamSizeOptions.map((e) => DropdownMenuItem(value: e, child: Text(e))).toList(),
